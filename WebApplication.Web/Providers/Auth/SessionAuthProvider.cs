...
namespace WebApplication.Web.Providers.Auth
{
    ...
    public class SessionAuthProvider : IAuthProvider
    {
        ...
        public SessionAuthProvider(IHttpContextAccessor contextAccessor, IUserDAL userDAL, IRecipeDAL recipeDAL)
        {
        ...
        public void Register(string username, string password, string role)
        {
            ...
            for (int i = 1; i < 4; i++)
            {
                Recipe reci = recipeDAL.GetRecipe(i);
                reci.UserId = GetCurrentUser().Id;
                recipeDAL.AddNewRecipe(reci);
            }
